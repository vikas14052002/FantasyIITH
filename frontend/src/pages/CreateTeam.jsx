...
function sortPlayers(players, sortKey, sortDir) {
  ...
  if (sortKey === 'points') {
    return sorted.sort((a, b) => dir * ((a.fantasy_points || 0) - (b.fantasy_points || 0)));
  }
  return sorted.sort((a, b) => dir * (a.credits - b.credits));
}
    ...
    <div className="create-team-page">
      ...
      <div className="ct-header">
        ...
        <div className="ct-header-info">
          ...
          <span className="ct-match-sub">Create Your Team</span>
        </div>
        ...
        {filteredPlayers.map(player => {
          ...
          return (
            <div key={player.player_id}
              className={`ct-player-row ${isSelected ? 'selected' : ''} ${disabled ? 'disabled' : ''}`}
              ...
              <div className="ct-player-left">
                {player.image_url ? (
                  <img className="ct-player-img" src={player.image_url} alt={player.name}
                    style={{ borderColor: isSelected ? 'var(--green)' : 'var(--border)' }} />
                ) : (
                  <div className="ct-player-avatar" style={{ background: isSelected ? 'var(--green)' : 'var(--bg-elevated)' }}>
                ...
                <div className="player-info">
                  ...
                  <div className="player-meta">
                    ...
                    {player.is_playing && <span className="ct-playing-tag">Playing</span>}
                  </div>
                </div>
              </div>
